...
def main():   
   ...
   linarity["Truth"]    = [ 1.0, 5.0, 10.0, 50.0, 126.75, 250.0, 499.8, 999.4, 4989.5, 9951.2 ]
   linarity["Recos"]    = [ 1.3, 4.2, 8.0,  40.7, 162.5,  293.3, 456.5, 923.1, 4347.9, 8245.3 ]
   linarity["Selected"] = [ 0.9, 4.0, 7.7,  40.5, 111.5,  249.2, 439.8, 886.7, 4215.0, 7922.1 ]
   linarity["Matched"]  = [ 0.9, 4.0, 7.7,  40.5, 111.25, 211.1, 418.8, 836.3, 3835.3, 6981.6 ]
