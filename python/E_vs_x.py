...
fEle = [ TF1("Ele_EofX0","[0]*exp([1]*x)+[2]/x+[3]/x^3",4,30),
         TF1("Ele_EofX1","[0]*exp([1]*x)+[2]/x+[3]/x^2",4,75),
         TF1("Ele_EofX2","[0]*exp([1]*x)+[2]/x+[3]/x^2",4,75),
         TF1("Ele_EofX3","[0]*exp([1]*x)+[2]/x+[3]/x^2+[4]/x^3+[5]",4,75),
         TF1("Ele_EofX4","[0]*exp([1]*x)+[2]/x+[3]/x^2+[4]",4,75),
       ]
       
fPos = [ TF1("Pos_EofX0","[0]*exp([1]*x)+[2]/x+[3]",-4,-30),
         TF1("Pos_EofX1","[0]*exp([1]*x)+[2]/x+[3]/x^2+[4]/x^3",-4,-75),
         TF1("Pos_EofX2","[0]*exp([1]*x)+[2]/x+[3]/x^2+[4]/x^3",-4,-75),
         TF1("Pos_EofX3","[0]*exp([1]*x)+[2]/x+[3]/x^2",-4,-75),
         TF1("Pos_EofX4","[0]*exp([1]*x)+[2]/x+[3]/x^2+[4]",-4,-75),
       ]
