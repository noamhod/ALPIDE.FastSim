...
fBvsx_pos.SetLineWidth(1)
res_pos = gr.Fit(fBvsx_pos,"MERS")
...
fBvsx_ele.SetLineColor(ROOT.kBlue)
fBvsx_ele.SetLineWidth(1)
res_ele = gr.Fit(fBvsx_ele,"MERS")
...
leg2.AddEntry(fBvsx_pos,"Fit (e^{+} side)","f")
leg2.AddEntry(fBvsx_ele,"Fit (e^{-} side)","f")
