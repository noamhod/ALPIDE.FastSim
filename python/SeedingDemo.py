...
# tT.Branch('x1Cluster_intrksys',x1Cluster_intrksys)
# tT.Branch('y1Cluster_intrksys',y1Cluster_intrksys)
# tT.Branch('z1Cluster_intrksys',z1Cluster_intrksys)
# tT.Branch('x2Cluster_intrksys',x2Cluster_intrksys)
# tT.Branch('y2Cluster_intrksys',y2Cluster_intrksys)
# tT.Branch('z2Cluster_intrksys',z2Cluster_intrksys)
# tT.Branch('x3Cluster_intrksys',x3Cluster_intrksys)
# tT.Branch('y3Cluster_intrksys',y3Cluster_intrksys)
# tT.Branch('z3Cluster_intrksys',z3Cluster_intrksys)
# tT.Branch('x4Cluster_intrksys',x4Cluster_intrksys)
# tT.Branch('y4Cluster_intrksys',y4Cluster_intrksys)
# tT.Branch('z4Cluster_intrksys',z4Cluster_intrksys)
         ...
         for j1 in range(Nwide1):
            ...
            # for j2 in range(narrpoints["Cls"][2].GetN()):
               ...
               # for j3 in range(narrpoints["Cls"][3].GetN()):
                  ...
                  # r4_intrksy = getpoint(allpoints["Cls"][4],j4)
                  # x1Cluster_intrksys.push_back( event.x1Cluster_intrksys[] )
                  # y1Cluster_intrksys.push_back( event.y1Cluster_intrksys[] )
                  # z1Cluster_intrksys.push_back( event.z1Cluster_intrksys[] )
                  # x2Cluster_intrksys.push_back( event.x2Cluster_intrksys[] )
                  # y2Cluster_intrksys.push_back( event.y2Cluster_intrksys[] )
                  # z2Cluster_intrksys.push_back( event.z2Cluster_intrksys[] )
                  # x3Cluster_intrksys.push_back( event.x3Cluster_intrksys[] )
                  # y3Cluster_intrksys.push_back( event.y3Cluster_intrksys[] )
                  # z3Cluster_intrksys.push_back( event.z3Cluster_intrksys[] )
                  # x4Cluster_intrksys.push_back( event.x4Cluster_intrksys[] )
                  # y4Cluster_intrksys.push_back( event.y4Cluster_intrksys[] )
                  # z4Cluster_intrksys.push_back( event.z4Cluster_intrksys[] )
